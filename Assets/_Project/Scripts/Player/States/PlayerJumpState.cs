...
public class PlayerJumpState : PlayerAirborneState
{
    ...
    public override void Enter()
    {
        ...
        // 1. 점프력 적용
        player.Movement.SetVelocity(player.Movement.RB.linearVelocity.x, player.Data.jumpForce);
    ...
    public override void Update()
    {
        ...
        if (player.CurrentVelocityY > 0 && !player.IsJumpButtonHeld)
        {
            ...
            player.Movement.SetVelocity(player.Movement.RB.linearVelocity.x, player.CurrentVelocityY * player.jumpCutMultiplier);
        }
