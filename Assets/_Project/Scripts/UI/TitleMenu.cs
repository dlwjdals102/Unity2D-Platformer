...
public class TitleMenu : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            continueButton.interactable = DataManager.Instance.hasSavedData;
        }
    ...
    public void OnClickNewGame()
    {
        ...
        SceneTransitionManager.Instance.TransitionToScene("Test", "StartPortal");
    }
    ...
    public void OnClickContinue()
    {
        ...
        if (string.IsNullOrEmpty(savedScene)) savedScene = "Stage_1";
